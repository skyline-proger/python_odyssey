...
class DScreen(Screen):
    def __init__(self, **kwargs):
        ...
        background_image = Image(source='a11db5ab-19f4-422d-ad4e-684896b98563.png', allow_stretch=True, keep_ratio=False)
    ...
    def type_text(self, dt):
        ...
        target_text = "Біз Атырауға тез жетеміз."
    ...
    def type_new_text(self, td):
        # Define the text to be typed
        target_text = "Қара, мұнда қайықтың түбінде бір нәрсе бар"
    ...
    def type_2new_text(self, td):
        target1_text = "Сәттілік! Бұл 15 мың теңге. \nБіз бірдеңе сатып ала аламыз. \nСең бұған қуаныштысыз ба?"
    ...
    def switch_to_pa_screen(self, dt):
    ...
    def on_answer(self, instance):
        ...
        if user_answer == user_answer:
            ...
            Clock.schedule_once(self.switch_to_pa_screen, 3)
