...
class SecondScreen(Screen):
    def __init__(self, **kwargs):
        ...
        self.label11 = Label(text='', font_size='15sp', font_name='CustomFont',
    ...
    def type_text(self, dt):
        ...
        if len(current_text) < len(target_text):
            ...
            Clock.schedule_interval(self.type_new_text, 0.05)
    ...
    def type_new_text(self, td):
        ...
        if len(current_text) < len(target_text):
            ...
            time.sleep(1.5)
            # Start the typing animation for the new text
            Clock.schedule_interval(self.type_2new_text, 0.05)
    ...
    def on_answer(self, instance):
        ...
        if user_answer == 'print()':
            ...
            prompt = f"Напиши подсказку на казахском языке для следующего кода {user_answer}, вот правильный код: {'print()'}, при этом не выводи правильный ответ, а просто укажи на синтаксические и логические ошибки"
